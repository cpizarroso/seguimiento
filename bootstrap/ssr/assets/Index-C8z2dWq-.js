...
//#region resources/js/pages/Reporte/Index.tsx
var estadoConfig = {
	iniciado: {
		label: "Iniciados",
		color: "text-blue-600"
...
function Reporte({ total_tramites, por_estado, iniciados_por_dia, finalizados_por_dia, tramites_por_funcionario, funcionarios, filtro_funcionario_id }) {
	const handleFiltroChange = (e) => {
		const value = e.target.value;
		router.get("/reporte", { funcionario_id: value || void 0 }, {
			preserveState: true,
			replace: true
		});
	};
